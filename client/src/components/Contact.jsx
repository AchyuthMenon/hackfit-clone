      ...
      <div className="glass-panel" style={{ padding: '3rem', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '1.2rem' }}>
          <p style={{ color: 'var(--text-white)' }}>
            <span style={{ fontWeight: 'bold' }}>Hisham Haskar (Chairperson ACM):</span> +91 95627 01344
          </p>
          <p style={{ color: 'var(--text-white)' }}>
            <span style={{ fontWeight: 'bold' }}>Abhijay Prakash (Chairperson FHC):</span> +91 80781 50645
          </p>
        </div>
      </div>
    </div>
